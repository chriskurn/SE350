...
public class BuildingTests {
     ...
     */
    @Test
    public void personEnterValidFloor() throws IllegalParamException,
    ...
    public void personEnterInvalidFloor() throws IllegalParamException,
            InvalidFloorException {
    ...
    public void testCorrectFloorNumber() {
        ...
        assertEquals("Number of floors should be equal", correctFloor, Building
                .getInstance().getNumberOfFloors());
    }
     ...
     */
    @Test
    public void loadPeopleCorrectlyUp() throws IllegalParamException,
            InvalidFloorException {
        ...
        ArrayList<Person> buildingPeople = Building.getInstance().loadPeople(
                startFloor, ElevatorDirection.UP);
